...
export const COURSE_TYPES = ['Major', 'General Education', 'Religion', 'Elective', 'Core'];
...
export const CATALOG = [
  ...
  { id: 'CSE 130', name: 'Intro to Programming with Competency', credits: 3, type: 'Major', dept: 'CSE', prereq: [] },
